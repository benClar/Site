...
require('./models/index.js')().then(function(resolvedDb){
    var db              = resolvedDb
...
//app.use(require('express-promise')());
    ...
    app.get('/', function(req, res) {
        console.log("GET /");
        var content = new jRend.HomeContent('text', db, req);
        var template = new jRend.StdTemplate(db, req, 'StandardBody', content);
